      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="text-center mb-12">
          ...
          lineHeight: '1.5'
            ...
            <span className="font-semibold text-yellow-400">90-Day Performance Guarantee:</span> If your new video doesn't lift one agreed metric we'll keep producing iterations free until it does.
          </p>
        </div>

        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
          <a href="https://forms.fillout.com/t/dr1jqRebxnus" target="_blank" rel="noopener noreferrer" onClick={() => {
          trackCTAClick('main_hero', 'Get Your Free Video Growth Plan');
          trackFormOpen('main_page_hero');
        }}>
            <Button size="lg" className="cinematic-cta text-lg px-10 py-6 font-semibold shadow-2xl hover:shadow-glow transition-all duration-500 transform hover:scale-105">
