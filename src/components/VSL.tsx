...
const VSL = () => {
  ...
  const testimonials = [{
    ...
    quote: "ContentLab transformed our onboarding experience. The video series increased our trial conversions by 67%.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          <a href="https://forms.fillout.com/t/dr1jqRebxnus" target="_blank" rel="noopener noreferrer">
            <Button 
              size="lg" 
              className="cinematic-cta text-xl px-10 py-6 shadow-glow hover:shadow-glow"
            >
