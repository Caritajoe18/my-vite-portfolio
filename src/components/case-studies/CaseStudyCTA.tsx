  ...
  return <section className="py-16 cinematic-section border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        animationDelay: '0.2s'
          ...
          trackCTAClick('case_study_cta', 'Get Your Free Video Growth Plan');
          trackFormOpen('case_studies_page');
        }}>
            <Button size="lg" className="cinematic-cta text-lg px-8 py-4 font-semibold shadow-2xl hover:shadow-glow">
