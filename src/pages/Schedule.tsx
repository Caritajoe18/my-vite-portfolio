...
const Schedule = () => {
  return <>
      <SEO title="Schedule a Call - Start Your Video Growth Journey | ContentLab" description="Book a free 15-minute discovery call to discuss your video content strategy. Get a custom projection and implementation timeline for your SaaS growth." keywords="schedule call, video strategy consultation, content marketing consultation, saas growth call" />
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-card rounded-2xl border border-border shadow-xl overflow-hidden">
              ...
              minHeight: '630px'
                ...
                <iframe src="https://calendly.com/kvit/15-minutes-discovery-call" width="100%" height="630" frameBorder="0" title="Schedule a call with ContentLab" style={{
                border: 0
              }} />
              </div>
            </div>
